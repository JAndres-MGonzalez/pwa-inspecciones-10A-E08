...
- **Commit de mi turno (SHA):** `8bfedaca892af8b580506edaa066b78bc13f1a62` — `feat(w02): manifest instalable y layout con app shell`, empujado a `origin/master` el 13 de septiembre de 2026.