...
| Dispositivo | APIs web sujetas a permisos y soporte; texto y listado bastan. No se asume ejecución continua en segundo plano | Las mismas APIs web disponibles; no se excluye hardware por no ser PWA | Integración directa con SDK, útil para periféricos específicos, bajo límites del propio sistema | Plugins y canales hacia código nativo; depende de compatibilidad y mantenimiento |
